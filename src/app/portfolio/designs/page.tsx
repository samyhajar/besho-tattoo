...
export default function DesignsPage() {
  ...
  const loadTattoos = async () => {
    try {
      ...
      const designTattoos = (data.tattoos || []).filter(
        (tattoo) => tattoo.category === "designs",
      );
      setTattoos(designTattoos);
      setPublicUrls(data.publicUrls || {});
    } catch (err) {
      console.error("Error loading designs:", err);
      setError(
        err instanceof Error ? err.message : "Failed to load designs portfolio",
      );
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-120px)]">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading designs portfolio...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-120px)]">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">
              Unable to Load Designs Portfolio
            </h2>
