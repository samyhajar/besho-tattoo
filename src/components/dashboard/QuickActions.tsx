    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-base">
          Manage your studio efficiently
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        ...
        >
          ...
          <div className="text-sm text-gray-600">
            Upload your latest work to the portfolio
          </div>
        </Link>
        ...
        >
          ...
          <div className="text-sm text-gray-600">
            Update your schedule for bookings
          </div>
        </Link>
        ...
        <Link
          ...
          className="w-full p-3 text-left bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors block"
        >
          <div className="font-medium text-base">Manage Events</div>
          <div className="text-sm text-gray-600">
            Create upcoming studio events for the homepage hero
          </div>
        </Link>
        ...
        >
          ...
          <div className="text-sm text-gray-600">
            Check your studio appointments
          </div>
        </Link>
      </CardContent>
    </Card>
